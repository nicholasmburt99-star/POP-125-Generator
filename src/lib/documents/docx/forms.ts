...
export function buildElectionToParticipateParagraphs(data: FormData): Paragraph[] {
  ...
  return [
    ...
    emptyLine(),
    body(`On the appropriate benefit enrollment form(s), I have enrolled for certain insurance coverages. I elect to receive the following coverage(s) under the ${shortLabel}:`),
    emptyLine(),
