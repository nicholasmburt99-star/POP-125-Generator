...
export function buildPlanDocumentParagraphs(data: FormData): Paragraph[] {
  ...
  p.push(body(`This Plan is a Premium Only Plan under Section 125 of the Internal Revenue Code \u2014 the narrow form of cafeteria plan permitted by the POP safe harbor of Proposed Treasury Regulation \u00a71.125-7(e). It permits Eligible Employees to pay the Employee share of premiums for one or more Employer-sponsored welfare benefit plans (typically group medical, dental, vision, and group term life coverage up to $50,000) on a pre-tax basis through salary reduction. Pre-tax salary-reduction contributions to Health Savings Accounts, Flexible Spending Accounts (Health, Limited-Purpose, Dependent Care, Adoption Assistance, or otherwise), or other reimbursement arrangements are not permitted under this Plan; an Employer wishing to offer such pre-tax benefits must adopt a full Cafeteria Plan under Code Section 125.`));
  p.push(emptyLine());
  ...
  p.push(definitionItem("10", "Employer", `means the ${entity} or any such entity specified in Item 1 of the Adoption Agreement, and any Affiliated Employer that adopts this Plan; any successor that maintains this Plan; and any predecessor that has maintained this Plan.`));
  ...
  if (data.benefits.groupTermLife) {
    p.push(sectionTitle("05. Group Term Life Premium Conversion \u2014 Section 79 Imputed Income"));
  ...
  p.push(body(`An Employee who meets the Eligibility Requirements of the Plan on the first day of, or during, a Plan Year may elect to participate in this Plan for all or the remainder of such Plan Year, provided he or she elects to do so before his or her effective date of participation pursuant to the Section titled: \u201cEffective Date of Participation\u201d, or for a newly Eligible Employee, no more than 30 days after the date on which the Employee first satisfies the Eligibility Requirements of the Plan. For any such newly Eligible Employee, if coverage under the underlying Insurance Contract is effective as of an earlier date, such Employee shall be eligible to participate retroactively as of that coverage effective date. Notwithstanding the foregoing, no Salary Redirection election may apply to a period of coverage that has not commenced under the applicable Insurance Contract; retroactive participation pursuant to this Section is limited to periods for which the Insurer in fact provides coverage to the Participant. Newly Eligible Employee Election amounts will be collected the first pay period on or after his or her election was received. However, if such Employee does not complete an application to participate and a benefit election form and deliver them to the Administrator before such date, his or her Election Period shall extend 30 calendar days after such date, or for such further period as the Administrator shall determine and apply on a uniform and nondiscriminatory basis. However, any election during the extended 30-day election period pursuant to this Section shall not be effective until the first pay period following the later of such Participant\u2019s effective date of participation pursuant to the Section titled: \u201cEffective Date of Participation\u201d or the date of the receipt of the election form by the Administrator, and shall be limited to the Benefit expenses incurred for the balance of the Plan Year for which the election is made. Any failure to elect the Benefits set forth herein shall constitute an Employee\u2019s election to not participate in the Plan during that Plan Year until a valid election is otherwise made in the manner set forth herein.`));
  ...
  p.push(body(`Any new election shall be effective at such time as the Administrator shall prescribe, but not earlier than the first pay period beginning after the election form is completed and returned to the Administrator. The following events constitute a “change in status” under Treasury Regulation §1.125-4(c). Additional permitted mid-year election change events under Code Section 125 and the Treasury regulations thereunder are described in subsections (b) through (j) below.`));
  ...
  p.push(sectionTitle("04. Application of Forfeited Amounts"));
  p.push(body(`This Plan is structured as a premium-only cafeteria plan under which Salary Redirections are applied to pay Premium Expenses for the elected Insurance Contracts. Accordingly, the Plan does not anticipate the routine generation of forfeitures or experience gains, since Salary Redirections are remitted to Insurers on the Participant’s behalf rather than held in a reimbursement account. To the extent any Salary Redirection amount is withheld from a Participant’s Compensation but cannot be applied to pay a Premium Expense (for example, because the Participant’s coverage terminates before the corresponding period of coverage), such amount shall be refunded to the Participant in accordance with the Section titled: “Termination of Employment” of Article II of this Plan and the Treasury regulations under Code Section 125. Any residual amount that cannot, after reasonable effort, be refunded to the Participant shall be retained by the Employer and applied to defray reasonable administrative expenses of the Plan.`));
  ...
  p.push(sectionTitle("05A. Controlling Document Hierarchy"));
  p.push(body(`This Premium Only Plan Document is the governing Section 125 document for Premium Conversion benefits provided through this Plan. Any Adoption Agreement, Summary Plan Description, election form, exhibit, or appendix is intended to supplement this Plan and shall not supersede it unless expressly stated. In the event of any conflict between this Plan Document and the Summary Plan Description, the Plan Document shall control. The precedence rule of the Section titled “Insurance Control Clause” above governs any conflict between this Plan Document and an Insurance Contract.`));
  ...
  p.push(body(`Notwithstanding anything in this Plan to the contrary, this Plan shall be operated in accordance with the Health Insurance Portability and Accountability Act of 1996, as amended (“HIPAA”), and the regulations issued thereunder, including the Privacy Rule (45 C.F.R. Parts 160 and 164, Subparts A and E), the Security Rule (45 C.F.R. Parts 160 and 164, Subparts A and C), and the Breach Notification Rule (45 C.F.R. Part 164, Subpart D), to the extent applicable to the Plan and to the underlying group health plans offered through the Plan.`));
