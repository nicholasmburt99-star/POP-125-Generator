...
export function buildSPDParagraphs(data: FormData): Paragraph[] {
  ...
  return [
    ...
    body(`If you leave our employ during the Plan Year, you will remain covered by insurance, but only for the period for which premiums have been paid prior to your termination of employment. Any Salary Redirection amounts withheld but not yet remitted to the carrier for a period of coverage beginning on or after your termination date will be refunded to you.`),
    ...
    sectionTitle(`${data.employer.stateOfGoverningLaw === "CA" ? "13" : "12"}. Claims and Appeals Procedure`),
    ...
    sectionTitle(`${data.employer.stateOfGoverningLaw === "CA" ? "14" : "13"}. HIPAA Special Enrollment Rights`),
