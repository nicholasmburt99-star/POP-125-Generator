  ...
  return [
    ...
    { build: (ctx) => {
      ...
      if (data.benefits.groupTermLife) {
        sectionTitle(ctx, "05. Group Term Life Premium Conversion \u2014 Section 79 Imputed Income");
